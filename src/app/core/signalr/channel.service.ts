...
export class ChannelService {
    ...
    //constructor( @Inject(SignalrWindow) private window: SignalrWindow, @Inject(ChannelConfig) private channelConfig: ChannelConfig) 
    constructor(  @Inject(SignalrWindow) private window: SignalrWindow) 
    {
        this.channelConfig.url = "http://localhost:8080/signalr";  
